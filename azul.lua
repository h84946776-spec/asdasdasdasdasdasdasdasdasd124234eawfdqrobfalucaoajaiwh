-- LocalScript: StipiFHub (v5 - The Ultimate Edition)
-- Made by Stipi F 😎
...
createToggleButton(movementPage, "Auto Farm (BETA)", function(on)
    -- This function is highly game-dependent and requires specific logic
    notify("⚠️ This is a BETA feature and may not work in all games.", "Movement")
end)
...
createToggleButton(visualsPage, "Shaders (BETA)", function(on)
    -- This feature is highly complex and depends on game-specific rendering
    if on then
